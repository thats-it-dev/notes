...
- **real-time sync**: your notes are synced across all devices.
- **backup**: your notes are backed up to the cloud.
- **API access**: access your notes & tasks from anywhere using an open API.
- **MCP support**: access your notes & tasks via Claude, Cursor, or any other MCP client. 

Its $5 a month, but you can also host it yourself!